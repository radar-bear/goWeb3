...
func (rpc *EthRPC) EthGasPrice() (big.Int, error) {
	...
	return HexString2BigInt(response)
}
...
func (rpc *EthRPC) EthGetStorageAt(data string, position int, tag string) (string, error) {
	...
	err := rpc.call("eth_getStorageAt", &result, data, Int2HexString(position), tag)
	return result, err
}
...
func (rpc *EthRPC) EthGetBlockTransactionCountByNumber(number int) (int, error) {
	...
	if err := rpc.call("eth_getBlockTransactionCountByNumber", &response, Int2HexString(number)); err != nil {
		return 0, err
	}
...
func (rpc *EthRPC) EthGetUncleCountByBlockNumber(number int) (int, error) {
	...
	if err := rpc.call("eth_getUncleCountByBlockNumber", &response, Int2HexString(number)); err != nil {
		return 0, err
	}
...
func (rpc *EthRPC) EthGetBlockByNumber(number int, withTransactions bool) (*Block, error) {
	return rpc.getBlock("eth_getBlockByNumber", withTransactions, Int2HexString(number), withTransactions)
}
...
func (rpc *EthRPC) EthGetTransactionByBlockHashAndIndex(blockHash string, transactionIndex int) (*Transaction, error) {
	return rpc.getTransaction("eth_getTransactionByBlockHashAndIndex", blockHash, Int2HexString(transactionIndex))
}
...
func (rpc *EthRPC) EthGetTransactionByBlockNumberAndIndex(blockNumber, transactionIndex int) (*Transaction, error) {
	return rpc.getTransaction("eth_getTransactionByBlockNumberAndIndex", Int2HexString(blockNumber), Int2HexString(transactionIndex))
}
